...
var setAuthCookies_1 = require("../utils/cookies/setAuthCookies");
/**
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                return [4 /*yield*/, userAuthentication_1.default.loginUser(email, password)];
            case 1:
                tokens = _b.sent();
                if (tokens) {
                    (0, setAuthCookies_1.setAuthCookies)(res, tokens);
                }
                return [2 /*return*/, res.status(200).json({ message: "Login successful" })];
            case 2:
                error_1 = _b.sent();
                if (error_1 instanceof Error) {
                    console.error("Error authenticating user:", error_1.message);
