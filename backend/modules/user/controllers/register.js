...
var userRegistration_1 = require("../services/userRegistration");
/**
...
var registerUser = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, username, email, password, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 2, , 3]);
                _a = req.body, username = _a.username, email = _a.email, password = _a.password;
                return [4 /*yield*/, userRegistration_1.default.addUser(username, email, password)];
            case 1:
                _b.sent();
                return [2 /*return*/, res.status(201).json("User registered successfully")];
            case 2:
                error_1 = _b.sent();
