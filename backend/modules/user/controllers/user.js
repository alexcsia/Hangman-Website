...
var getSanitizedUser_1 = require("../services/getSanitizedUser");
/**
...
var getUserProfile = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var userIdFromParams, userIdFromToken, userData, error_1;
    var _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                userIdFromParams = req.params.userId;
            ...
            case 1:
                _b.trys.push([1, 3, , 4]);
                return [4 /*yield*/, (0, getSanitizedUser_1.getSanitizedUser)(userIdFromParams)];
            case 2:
                userData = _b.sent();
            ...
            case 3:
                ...
                if (error_1 instanceof Error) {
                    console.error("Error retrieving user data:", error_1.message);
                    return [2 /*return*/, res.status(500).json({ message: "Could not retrieve user data" })];
                }
                return [3 /*break*/, 4];
